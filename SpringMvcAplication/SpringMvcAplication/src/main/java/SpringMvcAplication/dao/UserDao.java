			...
			.query(sql, getSqlParameterByModel(null), new UserMapper());
			 ...
			 private SqlParameterSource getSqlParameterByModel(User user){
			  ...
			  if(user != null){
			   ...
			   parameterSource.addValue("Prenom", user.getPrenom());
			   parameterSource.addValue("Nom", user.getNom());
			   parameterSource.addValue("Notes", user.getNotes());
			  }
			 ...
			 private static final class UserMapper implements RowMapper{
			  ...
			  public User mapRow(ResultSet rs, int rowNum) throws SQLException {
			   ...
			   user.setAddress(rs.getString("Notes"));
			 ...
			 public void addUser(User user) {
			  String sql = "INSERT INTO users(Prenom, Nom, Notes) 
